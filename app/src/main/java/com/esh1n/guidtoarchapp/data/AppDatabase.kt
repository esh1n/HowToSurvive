    ...
    private class WordDatabaseCallback(
        ...
        suspend fun populateDatabase(wordDao: CategoryDao, articleDao: ArticleDao) {
            ...
            val articles = arrayListOf(
                ...
                ArticleEntry(
                    "Холодовая травма",
                    "{text:Холодовая травма – расстройство функций организма из-за понижения температуры тела\n" +
                ...
                ArticleEntry(
                    "Стрельба",
                    "{link:https://journal.tinkoff.ru/luk/}" + "\n" +
                ...
                ArticleEntry(
                    "Землетрясение",
                    "{textBold:Если ты находишься в помещении, когда начинаются толчки:\n}" +
                            "{text:▪Если есть возможность – выбегай на улицу на открытый участок, подальше от домов, деревьев.\n" +
                ...
                ArticleEntry(
                    "Лесной пожар",
                    "{textBold:Если ты увидел возгорание в лесу, необходимо сразу же сообщить об этом, даже если горит совсем маленький участок.}" + "{text: Можно позвонить по единому номеру вызова экстренных оперативных служб – 112, а также на прямую линию лесной охраны – 8(800)100-94-00.\n" +
                            "\n" +
                ...
                ArticleEntry(
                    "Пищевое отравление",
                    "{text:Признаки пищевого отравления:\n" +
                            "- Тошнота\n" +
                            "- Рвота\n" +
                            "- Диарея\n" +
                            "- Боли в желудке\n" +
