...
import com.esh1n.guidtoarchapp.data.*
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext
import javax.inject.Inject

class PrepopulateDBUseCase @Inject constructor(private val appDatabase: AppDatabase) {

    suspend fun fillDB() {
        withContext(Dispatchers.IO) {
            populateDatabase(appDatabase.categoryDao(), appDatabase.articlesDao())
        }
    }

    private suspend fun populateDatabase(wordDao: CategoryDao, articleDao: ArticleDao) {
        wordDao.deleteAll()
        ...
        val articles = arrayListOf(
            ...
            ArticleEntry(
                ...
                "{textBold:Если началась стрельба:\n}" +
                        ...
                        "- ложись. Лицом вниз, руки и ноги согнуты – PAсное место. Подальше от окон, стеклянных предметов. Если есть возможность – беги в ванную, забаррикадируйся, лучше лечь на дно ванны. На улице спрятаться можно за выступы зданий, колонны, памятники. Нельзя прятаться рядом со стеклянными витринами, автомобилями.\n" +
            ...
            ArticleEntry(
                ...
                "{link:https://nasiliu.net/\n}" +
                        "{link:https://krizis-centr.ru/\n}" +
                        "{link:https://otkazniki.ru/\n}",
                "Насилие",
                false
            ),
            ArticleEntry(
                "Кибербезопасность",
                "{text:Кибербезопасность для детей }" +
                        "{link:https://www.youtube.com/watch?v=TSQN-dMehFA\n}" +
                        "{text:Про кибербуллинг }" +
                        "{text:https://www.youtube.com/watch?v=J_2KVC4zwz4\n}" +
                        "{text:Приключения робота Каспера }" +
                        "{link:https://www.youtube.com/watch?v=tt1eQaE_alQ&list=PLQQwOgZzcgt3-T2h1Es6u4SiiF9sopcp9\n}",
                "Безопасность в сети",
                false
            ),
            ArticleEntry(
                "Книги",
                "{text:Если тебе интересно узнать больше про свое тело:\n" +
                        "“Интимный ликбез с родителями и без”, Юлия Ярмоленко, Марьяна Гилевич\n" +
                        "“Давай поговорим про отношения” Роби Харрис с 12 лет\n" +
                        "“Твое личное тело”, Марва Ибрагим - для девушек с 12 лет\n}",
                "Половое воспитание",
                false
            )
