...
object Decorator {
    ...
    class Builder {
         ...
         * @param pair Pair of ViewHolder's ViewType and [ViewHolderDecor]
         */
         ...
         * @param pair Pair of ViewHolder's ViewType and [OffsetDecor]
         */
